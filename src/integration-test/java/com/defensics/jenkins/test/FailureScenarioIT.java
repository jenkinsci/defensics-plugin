...
import static com.defensics.jenkins.test.utils.Constants.PIPELINE_ERROR_TEXT;
...
import com.defensics.apiserver.client.DefensicsApiClient;
import com.defensics.apiserver.client.DefensicsApiV2Client;
import com.defensics.apiserver.model.SuiteInstance;
import com.defensics.client.DefensicsRequestException;
import com.defensics.client.UnsafeTlsConfigurator;
...
import com.defensics.jenkins.test.utils.CredentialsUtil;
import com.defensics.jenkins.test.utils.HttpSutRule;
import com.defensics.jenkins.test.utils.JenkinsJobUtils;
import com.defensics.jenkins.test.utils.ProjectUtils;
...
public class FailureScenarioIT {
  ...
  public void testRun_runOnSeparateNode() throws Exception {
    ...
    Path absoluteTestplanPath = Paths.get(
        "./src/integration-test/resources/com/defensics/jenkins/test/utils/http.testplan"
    ).toAbsolutePath();
