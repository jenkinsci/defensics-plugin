...
import com.defensics.jenkins.configuration.StepConfigurationValidator;
...
/**
 * This is the post build step for this plugin.
 */
public class FuzzPostBuildStep extends Recorder implements SimpleBuildStep {
  ...
  public FuzzPostBuildStep(String configurationFilePath) {
  ...
  @Override
  public FuzzPostBuildStepDescriptor getDescriptor() {
    return (FuzzPostBuildStepDescriptor) super.getDescriptor();
  }

  @Extension
  public static final class FuzzPostBuildStepDescriptor extends BuildStepDescriptor<Publisher>
    ...
    public FuzzPostBuildStepDescriptor() {
      super.load();
    }
